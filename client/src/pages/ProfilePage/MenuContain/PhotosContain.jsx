  ...
  return (
    <div className="w-full bg-white h-auto mt-2 shadow-sm rounded-lg border py-2 px-5">
      <div className="flex items-center justify-between ">
        ...
        <button className="bg-pink-700 rounded  p-2 mt-5 text-white shadow-md hover:bg-pink-700 hover:shadow-sm focus:bg-pink-700 focus:shadow-sm focus:outline-none focus:ring-0 active:bg-pink-800 active:shadow-sm transition duration-150 ease-in-out">
          Add Photos
        </button>
      </div>
